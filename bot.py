...
def boshqa_kb():
    """Boshqa xizmatlar submenu — yonma-yon tartib"""
    return ReplyKeyboardMarkup(keyboard=[
        [kbtn("💎 PUBG Mobile UC", "success"), kbtn("⭐ Telegram Stars", "primary")],
        [kbtn("💜 Telegram Premium", "primary"), kbtn("📱 Nomer olish", "success")],
...
async def phone_approve(cb: types.CallbackQuery):
    ...
    if row:
        ...
        msg_text = (
            ...
            "\n📞 <b>Kod olish uchun:</b>\n"
            "Admin'ga <a href=\"tel:+998777326306\">+998 77 732 63 06</a> raqamiga "
            "qo'ng'iroq qiling va yuborilgan kodni oling.\n"
            "🙏 Rahmat!".replace(",", " ")
        )
